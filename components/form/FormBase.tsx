...
export default function FormBase({ children, layout = "left" }: FormBaseProps) {
  return (
    <div className="grid place-items-center min-h-screen h-full w-screen backdrop-blur-lg">
      <div
        className={`flex rounded-3xl my-8 overflow-clip w-full max-w-[calc(100%-2rem)] sm:max-w-[calc(100%-8rem)] md:max-w-[calc(100%-16rem)] lg:w-auto lg:max-w-none shadow-xl ${
      ...
      >
        ...
        <div
          ...
          className="relative flex flex-col gap-4 justify-center items-center w-full lg:w-auto lg:max-w-[28rem] min-w-[24rem] lg:min-w-[28rem] min-h-[36rem] bg-cover bg-center text-white"
        >
          {children}
        </div>
      </div>
