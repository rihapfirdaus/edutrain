      ...
      {isShowing && (
        ...
        >
          <div
            ...
            className="flex flex-col justify-center items-center text-white font-bold bg-cover bg-center max-w-80 min-w-80 rounded-3xl min-h-64 shadow-xl relative gap-4 border-2 p-8 my-2 transition-opacity duration-75"
